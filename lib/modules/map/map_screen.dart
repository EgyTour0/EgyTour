...
import 'package:egytour/modules/map/placesdetails.dart';
...
class _MapScreenState extends State<MapScreen> {
  ...
  CameraPosition _kGooglePlex =
      CameraPosition(target: LatLng(27.0, 31.0), zoom: 6.9);
  ...
  List<Step> stepList() => [
        Step(
            ...
            subtitle: Text('first location to start the trip'),
            title: Text('Start 8 am'),
            content: Center(
                child: Column(
              ...
              children: [
                ...
                Text(
                    'distance between your location and the first location is ' +
                        destinationlist.elementAt(0).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
                // Text('time to travel ' +
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(1).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(2).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(3).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(4).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text(
                    'distance between your location and the first location is ' +
                        destinationlist.elementAt(5).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(6).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(7).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            content: Center(
              ...
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(8).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
        ...
        Step(
            ...
            subtitle: Text('last location'),
            title: Text('ends 6 pm'),
            content: Center(
                child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Text('distance between you and location is ' +
                    destinationlist.elementAt(9).distanceText.toString()),
                SizedBox(
                  height: 10,
                ),
                Text('Time to spend here 30min'),
  ...
  distanceCalculation() async {
    ...
    distanceURL = distanceURL +
        '&origins=${cl.latitude}%2C${cl.longitude}&key=AIzaSyDxt0hqGVcHzQsgMZaZbLgNIXjgnTxrh4I';
    print(distanceURL);
    var distance = [];
    var duration = [];
