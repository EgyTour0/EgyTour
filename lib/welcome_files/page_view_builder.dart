                    ...
                    children: List.generate(3, (indexDots){
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:index ==indexDots? Color(0xFF2a5885): Color(0xFF2a5885).withOpacity(0.3),
                        ),
                      );
                    }
                    ),
                    ...
                    children: [
                      ...
                      Container(
                       ...
                       child: Text(
                         ''+TextOnPhoto3[index],
                         style: TextStyle(
                          color: Color(0xFF878593) ,fontSize: 19,
                        ),
                        ),
                      ),
                      SizedBox(height: 30,),
